...
-- Online Correlative Scan Matcher (Optimized for 20Hz LiDAR stream on i5 NUC)
...
-- Motion Filter: Immediate updates per 20Hz scan
...
-- Submaps (50 scans @ 20Hz = 2.5 seconds per submap)
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 50
TRAJECTORY_BUILDER_2D.submaps.grid_options_2d.grid_type = "PROBABILITY_GRID"
TRAJECTORY_BUILDER_2D.submaps.grid_options_2d.resolution = 0.05

-- Pose Graph Optimization (optimize every 20 nodes)
